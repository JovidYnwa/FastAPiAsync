...
Revision ID: eedada041389
Revises: 
Create Date: 2023-03-12 23:15:47.085638
...
def upgrade() -> None:
    ...
    sa.Column('email', sa.String(length=102), nullable=True),
    ...
    sa.Column('status', sa.Enum('pending', 'approver', 'rejected', name='state'), server_default='pending', nullable=False),
